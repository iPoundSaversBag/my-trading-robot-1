#!/usr/bin/env python3
"""
Simplified ML Improvements for Regime Classification
===================================================

This script implements core ML improvements without complex dependencies:
1. Advanced Feature Engineering - Primary approach
2. Hyperparameter optimization - For fine-tuning
3. Basic ensemble methods - For robustness
...
# ML libraries (no imblearn to avoid import warnings)
...
class AdvancedRegimeFeatureEngineer:
    ...
    def _get_original_features(self, df):
        """Get the original features used in base model"""
        ...
        try:
            ...
            # If TA calculation fails, fill with NaN; downstream fill will handle
        ...
        # Back/forward fill then replace any remaining inf/NaN
...
class EnhancedRegimeClassifier:
    ...
    def train_enhanced_model(self, data_files):
        """Train enhanced model with improvements (no SMOTE dependencies)"""
        ...
        # 2. Use class weights instead of SMOTE
        ...
        best_model = self._optimize_hyperparameters(X_scaled, y, sample_weights)
        
        # 5. Train ensemble model
        print("🎭 Training ensemble model...")
        ensemble_model = self._train_ensemble(X_scaled, y, sample_weights)
        
        # 6. Evaluate models
        print("📈 Evaluating models...")
        self._evaluate_models(X_scaled, y, best_model, ensemble_model)
        ...
        for file_path in data_files:
            if Path(file_path).exists():
                ...
                if len(df) > 5000:
                    ...
                    print(f"  📊 Using sample of 5,000 rows for faster processing")
                
                # Engineer advanced features
                features = self.feature_engineer.engineer_advanced_features(df)
                
                # Generate labels using simplified rule-based approach
    ...
    def _optimize_hyperparameters(self, X, y, sample_weights):
    ...
    def _train_ensemble(self, X, y, sample_weights):
